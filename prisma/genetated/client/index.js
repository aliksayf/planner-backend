...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Projects\\planner\\planner-backend\\planner-backend\\prisma\\genetated\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
path.join(process.cwd(), "prisma/genetated/client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/genetated/client/schema.prisma")
